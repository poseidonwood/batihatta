       ...
       <div class="col-md-12">
         <div class="card card-success">
           <div class="card-header">
             <a href="#" class="btn btn-primary" onclicl="Redirect()" data-toggle="modal" data-target="#mulaihitung">
                   ...
                   <tr>
                     ...
                     <td class="text-center align-middle">
                       <div class="btn-group btn-group-sm">
                         ...
                         <a class='btn btn-danger btn-sm' href="proses-hapus.php?id=<?= $id_bobot; ?>" onclick="return confirm(' Anda yakin ingin menghapus?');">
