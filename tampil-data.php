        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            <tbody>
              ...
              if (isset($cari)) {
                $jumlah_record = mysqli_query($koneksi, "SELECT COUNT(*) FROM kriteria 
                                              WHERE id_kriteria LIKE '%$cari%' OR nama_kriteria LIKE '%$cari%'");
              } else {
                $jumlah_record = mysqli_query($koneksi, "SELECT COUNT(*) FROM kriteria");
              }

              $jumlah  = mysqli_fetch_array($jumlah_record, 0);
                ...
                echo "  <tr>
                      ...
                      <td width='100'>
                        <div class=''>
                          ...
                          ";
              ?>
                <a data-toggle="tooltip" data-placement="top" title="Hapus" class="btn btn-danger btn-sm" href="proses-hapus.php?id=<?php echo $data['id_kriteria']; ?>" onclick="return confirm('Anda yakin ingin menghapus  <?php echo $data['nama_kriteria']; ?>?');">
